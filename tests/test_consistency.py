...
These tests verify that TabPFN models produce consistent predictions across code changes.
If predictions change, developers must explicitly acknowledge and verify the improvement.
"""
...
def get_prediction_hash(model_predictions: np.ndarray) -> str:
    ...
    prediction_str = np.array2string(model_predictions, precision=8, suppress_small=True)
...
REFERENCE_HASHES = {
    "iris_classifier": "74d8ebd26158c13936819d378da6dd1bd3d776336327db44d7065ff5e9a1a305",
    "breast_cancer_classifier": "2afcc05426156fde62f7c1d8d5a7c34916b0fafd0f5849dd4f57ce2da13e2b68",
    "boston_regressor": "e173b38a048088ca34ac095ddf2fc237a34426c76b4c2729afa453cdd27ffaaa",
    "diabetes_regressor": "280c25c599e6d16bf13b4e3398a9b10bb7a8161004d5df2209ead2f30bfe8ed0",
}
...
class TestModelConsistency:
    ...
    def test_breast_cancer_classifier_consistency(self, breast_cancer_data):
        """Verify TabPFNClassifier predictions on Breast Cancer dataset are consistent."""
    ...
    def test_boston_regressor_consistency(self, boston_data):
        """Verify TabPFNRegressor predictions on Boston Housing dataset are consistent."""
...
class TestHashRobustness:
    """Verify that our hash function correctly detects changes in data and model behavior."""
...
def update_reference_hashes():
    ...
    print("Updated reference hashes:")
    print(json.dumps(reference_hashes, indent=4))
    print("\nTo update tests, replace the REFERENCE_HASHES dictionary in test_consistency.py with:")
    print("REFERENCE_HASHES = {")
